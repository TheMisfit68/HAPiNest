...
struct MainConfiguration{
    ...
    struct HomeKit{
        ...
        static let Accessories:[ (Accessory,AccessoryDelegate?) ] = [
            ...
            // MARK: - Smart Lights
            ( Accessory.Lightbulb(info: Service.Info(name: "Balk", serialNumber: "10000", manufacturer: "Milight")),    MilightDelegate(name: "Balk", driver:MilightDriverV6(ipAddress:"192.168.0.52"), zone: .zone01) ),
            ( Accessory.Lightbulb(info: Service.Info(name: "UFO", serialNumber: "10002", manufacturer: "Milight")),     MilightDelegate(name: "UFO", driver:MilightDriverV6(ipAddress:"192.168.0.52"), zone: .zone02) ),
